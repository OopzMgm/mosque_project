...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ตารางข้อมูลสัปปุรุษที่อยู่ในระบบ</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:info">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">ตารางข้อมูลสัปปุรุษที่อยู่ในระบบ</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                            ...
                            WHERE b.board_id=$board_id AND status_quo ='ยังอยู่'  ORDER BY house_no"
                                ...
                                echo "<table  id='example1' class='table table-bordered table-striped projects'>";
                                    ...
                                    $item = 0;
                                        while($row = mysqli_fetch_array($result)) { 
                                           ...
                                           <a href='create_member.php?ID=$row[0]' class='btn btn-info btn-sm'> <i class='fas fa-plus-circle'>
                                           </i></a>
                                         </td> ";
                                           echo "</tr>";
                                        }
