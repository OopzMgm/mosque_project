...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">แก้ไขข้อมูลสมาชิกกองทุนผู้เสียชีวิต<h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:info">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">แก้ไขข้อมูลสมาชิกกองทุนผู้เสียชีวิต</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <form role="form" action="update_member_db.php" method="post" class="form-horizontal"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="ref_suppurude_id" class="form-control"
                                            value="<?php echo 'M00'.$row['member_id'];?>" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="telephone_member" class="form-control" pattern="[0-9]{10}" value="<?php echo $row['telephone_member'];?>" >
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                ...
                <div class="card-footer">
                    <div class="float-right">
                        ...
                        <input type="hidden" name="name_edit_member" value="<?php echo $f_name_board;?>">
                        <input type="hidden" name="date_edit_member" value="<?php echo date('Y-m-d H:i:s');?>">
