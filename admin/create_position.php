...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">เพิ่มข้อมูลตำแหน่งคณะกรรมการ<h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:green">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">เพิ่มข้อมูลตำแหน่งคณะกรรมการ</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" action="create_position_db.php" method="post">
                        <div class="row">
                        </div>
                        <div class="col-sm-6">
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="position_name" class="form-control" placeholder="ป้อน . . .">
                            </div>
                        </div>
                </div>
                <!-- /.card-body -->
