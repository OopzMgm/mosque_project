...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ตารางบันทึกข้อมูลใบมรณะบัตร</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:green">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">ตารางบันทึกข้อมูลใบมรณะบัตร</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                            ...
                            WHERE status_quo ='เสียชีวิต'  ORDER BY suppurude_id DESC"
                                ...
                                echo "<table  id='example1' class='table table-bordered table-striped projects'>";
                                    ...
                                    $item = 0;
                                        while($row = mysqli_fetch_array($result)) { 
                                           ...
                                           <a href='create_death.php?ID=$row[0]' class='btn btn-info btn-sm'> <i class='fas fa-save'>
                                           </i></a>
                                         </td> ";
                                           echo "</tr>";
                                        }
