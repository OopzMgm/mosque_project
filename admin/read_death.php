...
$ID = $_GET['ID'];
$sql = "
SELECT *,YEAR( FROM_DAYS( DATEDIFF( NOW( ) , birthday_sup ) ) ) as age FROM tbl_death as d 
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-7">
                            ...
                            <ul class="ml-4 mb-0 fa-ul text-muted">
                                <li class="middle"><span class="fa-li"><i class="fas fa-lg fa-home"></i></span>
                                    ที่อยู่ :
                                    <?php echo 'หมู่ที่ '.$row['villageno'] .' ซอย/แยก '.$row['lane'] .' ถนน/คลอง '.$row['street'];?>
                        ...
                        <div class="col-5 text-left">
                            ...
                            <h2 class="text-muted text-md"><b>อายุ ณ วันที่ตาย: </b> <?php echo $row['age'];?>
                            </h2>
