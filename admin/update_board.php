...
WHERE position_id!=$ref_position_id" or die("Error:" . mysqli_error());
$result2 = mysqli_query($condb, $query);

$query2 = "SELECT * FROM tbl_area_board 
WHERE area_id!=$ref_area_id" or die("Error:" . mysqli_error());
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">แก้ไขข้อมูลคณะกรรมการ<h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:green">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">แก้ไขข้อมูลคณะกรรมการ</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" action="update_board_db.php" method="post" class="form-horizontal"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>ตำแหน่ง</label>
                                    <select name="ref_position_id" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="ref_area_id" class="form-control">
