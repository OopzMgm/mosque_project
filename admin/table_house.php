...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ตารางข้อมูลสำเนาทะเบียนบ้าน</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:green">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">ตารางข้อมูลสำเนาทะเบียนบ้าน</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <a class="btn btn-secondary btn-sm" href="../file/code_house.php" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a>
                    ...
                    <div class="card-body">
                        <?php
                            ...
                            INNER JOIN tbl_board as b ON b.board_id=h.ref_board_id" or die("Error:" . mysqli_error());
                                ...
                                echo "<table  id='example1' class='table table-bordered table-striped projects'>";
                                    ...
                                    $item = 0;
                                        while($row = mysqli_fetch_array($result)) { 
                                            ...
                                            <a href='update_house.php?ID=$row[0]' class='btn btn-info btn-sm'> <i class='fas fa-pencil-alt'>
                                            </i></a><hr>
                                            <a href='delete_house_db.php?ID=$row[0]' onclick=\"return confirm('ยืนยันการลบ?')\" class='btn btn-danger btn-sm'> <i class='fas fa-trash'>
                                            </i></a></td> ";
                                            echo "</tr>";
                                        }
                                    echo "
