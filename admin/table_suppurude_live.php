...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ตารางข้อมูลสัปปุรุษที่ยังมีชีวิต</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:green">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">ตารางข้อมูลสัปปุรุษที่ยังมีชีวิต</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-header">
                  ...
                  <a class="float-right btn btn-secondary btn-sm" href="../file/code_suppurude_live.php" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a>
                  </div>
                   <div class="card-body">
                        <?php
                               ...
                               WHERE status_quo = 'ยังอยู่' ORDER BY house_no ASC" or die("Error:" . mysqli_error());
