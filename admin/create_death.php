...
$ID = $_GET['ID'];
$sql = "
SELECT *,YEAR( FROM_DAYS( DATEDIFF( NOW( ) , birthday_sup ) ) ) as age FROM tbl_suppurude 
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">เพิ่มข้อมูลใบมรณะบัตร<h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:green">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">เพิ่มข้อมูลใบมรณะบัตร</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <form role="form" action="create_death_db.php" method="post" class="form-horizontal"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="ref_suppurude_id" class="form-control"
                                            value="<?php echo 'S00'.$row['suppurude_id'];?>" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5">
                            ...
                            <div class="col-md-2">
                                <a class="float-right btn btn-dark btn-sm" href="./table_death_create.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="d_certificate" pattern="[0-9]{5,15}" class="form-control" placeholder="ป้อน . . ."
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>ออกโดย</label>
                                <input type="text" name="officer" class="form-control" placeholder="ป้อน . . ."
                                    required>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="datetime-local" name="date_death" class="form-control"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="death_age" class="form-control"   value="<?php echo $row['age'];?>" disabled>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select name="cause_death" class="form-control" required>
                                    <option></option>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="prayer_place" class="form-control" placeholder="ป้อน . . .">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>สถานที่ฝัง</label>
                                <input type="text" name="burial_ground" class="form-control" placeholder="ป้อน . . .">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                ...
                <div class="card-footer">
                    <div class="float-right">
                        ...
                        <input type="hidden" name="death_age" value="<?php echo $age;?>">
...
$(document).ready(function() {
    ...
    $('a[href^="./table_death_create.php"]').addClass('nav-item has-treeview menu-open nav-link active ');
