        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- <a class="btn btn-secondary btn-sm" href="../file/file_member.pdf" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a> -->
                <a class="btn btn-secondary btn-sm" href="../file/code_member.php" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a>
<!--                         
