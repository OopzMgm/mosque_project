...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ตารางข้อมูลสัปปุรุษที่เสียชีวิต</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:green">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">ตารางข้อมูลสัปปุรุษที่เสียชีวิต</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                ...
                <div class="card-header">
                  ...
                  <a class="btn btn-success btn-sm" href="./table_suppurude_live.php">
                      ...
                      <!-- <a class="float-right btn btn-secondary btn-sm" href="../file/file_suppurude_death.pdf" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a> -->
                  <a class="float-right btn btn-secondary btn-sm" href="../file/code_suppurude_death.php" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a>
                  </div>
                   <div class="card-body">
                        <?php
                               ...
                               WHERE status_quo = 'เสียชีวิต' ORDER BY suppurude_id DESC" or die("Error:" . mysqli_error());
