        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- <a class="btn btn-secondary btn-sm" href="../file/file_marriage_all.pdf" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a> -->
                <a class="btn btn-secondary btn-sm" href="../file/code_marriage_all.php" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a>
                    ...
                    <div class="card-body">
                        <?php
                             ...
                             ORDER BY marriage_id DESC" or die("Error:" . mysqli_error());
                                ...
                                echo "<table  id='example1' class='table table-bordered table-striped'>";
                                    ...
                                    $item = 0;
                                        while($row = mysqli_fetch_array($result)) { 
                                            ...
                                            echo "<td>" .$row["title_mate"] .''.$row["firstname_mate1"] .' '.$row["lastname_mate1"] .  "</td> "; 
                                            echo "<td align='center'>" .date('d-m-Y', strtotime($row['wedding_date1'])). "</td> "; 
                                               ...
                                               <a href='update_marriage.php?ID=$row[0]' class='btn btn-info btn-sm'> <i class='fas fa-pencil-alt'>
                                               </i></a>
