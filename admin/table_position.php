        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- <a class="btn btn-secondary btn-sm" href="../file/file_position.pdf" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a> -->
                    <a class="btn btn-secondary btn-sm" href="../file/code_position.php" title="PDF [new window]" target="_blank"><i class="fas fa-print"> พิมพ์รายงาน</i></a>
                                ...
                                echo "<table  id='example1' class='table table-bordered table-striped'>";
                                    ...
                                    $item = 0;
                                        while($row = mysqli_fetch_array($result)) { 
                                            ...
                                            <a href='update_position.php?ID=$row[0]' class='btn btn-info btn-sm'> <i class='fas fa-pencil-alt'>
                                            </i> แก้ไข</a></td> ";
